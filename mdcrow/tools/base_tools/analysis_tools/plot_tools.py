'''
This script defines a LangChain tool that parses OpenMM simulation CSV logs 
to automatically generate and save plots of physical parameters against time or steps.
'''
